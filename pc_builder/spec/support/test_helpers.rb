...
module TestHelpers
  ...
  def psu(attrs = {})
    Psu.create!({ brand: "Corsair", name: "RM850x", model_number: "CP-9020200-NA",
                  price_cents: 13900, wattage: 0 }.merge(attrs))
  end
end
