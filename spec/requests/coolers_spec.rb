...
RSpec.describe 'Coolers', type: :request do
  describe 'GET /index' do
    ...
    it 'displays coolers' do
      cooler(brand: 'Noctua', name: 'NH-D15')
      cooler(brand: 'Corsair', name: 'H100i')
      get '/coolers'
  ...
  describe 'GET /show' do
    it 'returns http success' do
      test_cooler = Cooler.create!(brand: 'Noctua', name: 'Test Cooler', model_number: 'TEST-001', price_cents: 8000,
                                   wattage: 3)
