...
RSpec.describe 'Parts', type: :request do
  before do
    @cpu = Cpu.create!(name: 'AMD Ryzen 7', brand: 'AMD', price_cents: 29_900, wattage: 65)
    @gpu = Gpu.create!(name: 'RTX 4070', brand: 'NVIDIA', price_cents: 59_900, wattage: 200)
    @mb  = Motherboard.create!(name: 'ASUS B550', brand: 'ASUS', price_cents: 14_900, wattage: 50)
    ...
    @case = PcCase.create!(name: 'NZXT H7', brand: 'NZXT', price_cents: 12_900, wattage: 0)
    @psu = Psu.create!(name: 'Corsair 750W', brand: 'Corsair', price_cents: 11_900, wattage: 750)
  end
