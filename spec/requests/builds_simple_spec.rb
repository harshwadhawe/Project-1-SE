...
RSpec.describe 'Builds', type: :request do
  ...
  let!(:cpu) { Cpu.create!(name: 'Test CPU', brand: 'TestBrand', price_cents: 30_000, wattage: 95) }
  let!(:gpu) { Gpu.create!(name: 'Test GPU', brand: 'TestBrand', price_cents: 50_000, wattage: 200) }
