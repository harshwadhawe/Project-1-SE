...
RSpec.describe PcCase, type: :model do
  describe 'inheritance' do
    ...
    it 'creates with correct STI type' do
      pc_case = PcCase.create!(brand: 'Fractal', name: 'Meshify 2', price_cents: 17_000, wattage: 0)
  ...
  describe 'Case alias' do
    ...
    it 'allows Case.all to work' do
      PcCase.create!(brand: 'Phanteks', name: 'P400A', price_cents: 11_000, wattage: 0)
  ...
  describe 'STI integration' do
    it 'can be found as Part' do
      pc_case = PcCase.create!(brand: 'Fractal', name: 'Define 7', price_cents: 16_000, wattage: 0)
    ...
    it 'appears in Part.all' do
      ...
      PcCase.create!(brand: 'Corsair', name: '4000D', price_cents: 10_500, wattage: 0)
